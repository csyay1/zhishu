...
insert  into `mgt_banji`(`id`,`no`,`name`,`grade`,`year`,`type`,`school_id`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('1','2014112','三年级二班','3',NULL,'1','1','10','2014-07-25 13:57:15','10','2014-07-25 13:57:15','','0'),('1c0d1a4f1e6d4308a0b73280760558af','456789','初三2班','3','2014','2','58919b97657645bc900aa6efa30b726d','10','2014-07-29 14:01:43','10','2014-07-30 14:01:16','','0'),('9bd8a8b8852c4ade9dddfe90a5a670a8','123789','初三1班','3',NULL,'1','58919b97657645bc900aa6efa30b726d','10','2014-07-26 16:02:01','10','2014-07-26 16:02:01','呵呵','0'),('ab23637b9c7a4fbda9ac8e0862e67d53','214578','初三3班','3','2014秋季','1','58919b97657645bc900aa6efa30b726d','10','2014-07-30 13:56:25','10','2014-07-30 14:01:37','','0');

/*Table structure for table `mgt_message` */

DROP TABLE IF EXISTS `mgt_message`;

CREATE TABLE `mgt_message` (
  `id` varchar(64) NOT NULL COMMENT 'id',
  `content` varchar(1000) NOT NULL COMMENT '消息内容',
  `send_to` varchar(64) DEFAULT NULL COMMENT '消息接收者',
  `status` char(1) NOT NULL DEFAULT '0' COMMENT '消息状态',
  `create_by` varchar(64) DEFAULT NULL COMMENT '消息创建者',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT NULL COMMENT '更新者',
  `update_date` datetime DEFAULT NULL COMMENT '更新时间',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
...
/*Data for the table `mgt_message` */

insert  into `mgt_message`(`id`,`content`,`send_to`,`status`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('5e13abd8f38240e393cad77cb114489f','你的小孩到校了','2025677ee9b847b893695fc1ab423622','1','1','2014-08-12 17:00:53','1','2014-08-12 17:00:53','','0'),('a6c46ba7a245409ebc7d594b7834a960','hahahaha','8ab3ced4f9034b79baa7cc959f51d364','1','3','2014-08-12 17:42:21',NULL,'2014-08-12 17:42:21',NULL,'0'),('c2ba21dc11c04a91b41f85f2b12f6865','你的小孩到校了2','2025677ee9b847b893695fc1ab423622','2','1','2014-08-12 17:05:18','1','2014-08-12 17:06:41','','0');
...
insert  into `mgt_school`(`id`,`no`,`name`,`type`,`address`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('1','110110','师大附小','1','北京市哈哈哈哈哈哈哈哈哈哈哈','10','2014-07-25 13:56:20','10','2014-07-25 13:56:20','','0'),('58919b97657645bc900aa6efa30b726d','123456','大北邮未来附中','1','明光桥','10','2014-07-26 16:00:46','10','2014-07-26 16:00:46','做梦','0');

/*Table structure for table `mgt_sign` */

DROP TABLE IF EXISTS `mgt_sign`;

CREATE TABLE `mgt_sign` (
  `id` varchar(64) NOT NULL COMMENT 'id',
  `user_id` varchar(64) NOT NULL COMMENT '被通知家长',
  `type` char(1) NOT NULL DEFAULT '0' COMMENT '记录类型',
  `value` char(1) NOT NULL DEFAULT '0' COMMENT '记录状态',
  `create_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT NULL COMMENT '更新者',
  `update_date` datetime DEFAULT NULL COMMENT '更新时间',
  ...
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '删除标记',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='到校离校记录';

/*Data for the table `mgt_sign` */

insert  into `mgt_sign`(`id`,`user_id`,`type`,`value`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('1','8ab3ced4f9034b79baa7cc959f51d364','1','1','3','2014-07-14 08:00:00','3','2014-07-14 08:00:00',NULL,'0'),('2','6','2','4','8','2014-07-13 08:00:00','8','2014-07-13 08:00:00',NULL,'0'),('66f4cc2735e84d44a8654111c2ff753b','8ab3ced4f9034b79baa7cc959f51d364','1','1','3','2014-08-04 16:30:00','3','2014-08-04 16:30:00',NULL,'0'),('799b0939b8dd4a5082972c28fc336f34','8ab3ced4f9034b79baa7cc959f51d364','1','1','3','2014-08-12 17:42:21','3','2014-08-12 17:42:21',NULL,'0'),('a28d60c829d64dc39c9607537d0b4c23','8ab3ced4f9034b79baa7cc959f51d364','1','1','3','2014-08-04 16:10:44','3','2014-08-04 16:10:44',NULL,'0');

/*Table structure for table `mgt_token` */

DROP TABLE IF EXISTS `mgt_token`;

CREATE TABLE `mgt_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(64) NOT NULL COMMENT '令牌',
  `user_id` varchar(64) NOT NULL COMMENT '用户',
  `scope` varchar(1000) DEFAULT NULL COMMENT '权限范围',
...
/*Data for the table `mgt_token` */

insert  into `mgt_token`(`id`,`token`,`user_id`,`scope`,`expire_date`,`create_date`,`update_date`) values (1,'d5af6e4299db420f959ad081bce51a8a','3',NULL,'2014-08-13 17:42:12','2014-07-29 13:32:55','2014-08-12 17:42:12'),(2,'b3a2495f7a19409ca1c8f3e40734b170','10',NULL,'2014-07-30 17:04:21','2014-07-29 15:08:28','2014-07-29 17:04:21'),(3,'844151c59c3840a8a70aaab281ec4029','8ab3ced4f9034b79baa7cc959f51d364',NULL,'2014-07-31 14:26:50','2014-07-30 14:21:01','2014-07-30 14:26:50');

/*Table structure for table `mgt_user_banji` */

DROP TABLE IF EXISTS `mgt_user_banji`;

CREATE TABLE `mgt_user_banji` (
  `user_id` varchar(64) NOT NULL COMMENT '用户编号',
  `banji_id` varchar(64) NOT NULL COMMENT '班级编号',
  PRIMARY KEY (`user_id`,`banji_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户-班级';

/*Data for the table `mgt_user_banji` */

insert  into `mgt_user_banji`(`user_id`,`banji_id`) values ('13','ab23637b9c7a4fbda9ac8e0862e67d53'),('14','1c0d1a4f1e6d4308a0b73280760558af'),('2025677ee9b847b893695fc1ab423622','ab23637b9c7a4fbda9ac8e0862e67d53'),('3','ab23637b9c7a4fbda9ac8e0862e67d53'),('4','1c0d1a4f1e6d4308a0b73280760558af'),('5','9bd8a8b8852c4ade9dddfe90a5a670a8'),('6','9bd8a8b8852c4ade9dddfe90a5a670a8'),('7','9bd8a8b8852c4ade9dddfe90a5a670a8'),('7','ab23637b9c7a4fbda9ac8e0862e67d53'),('8','9bd8a8b8852c4ade9dddfe90a5a670a8'),('8ab3ced4f9034b79baa7cc959f51d364','ab23637b9c7a4fbda9ac8e0862e67d53'),('9','1'),('cabc117c4e9f4f1cb7cb90d97043ad1a','1');
...
insert  into `sys_dict`(`id`,`label`,`value`,`type`,`description`,`sort`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('1','正常','0','del_flag','删除标记',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('10','黄色','yellow','color','颜色值',40,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('11','橙色','orange','color','颜色值',50,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('12','默认主题','default','theme','主题方案',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('13','天蓝主题','cerulean','theme','主题方案',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('14','橙色主题','readable','theme','主题方案',30,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('15','红色主题','united','theme','主题方案',40,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('16','Flat主题','flat','theme','主题方案',60,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('17','国家','1','sys_area_type','区域类型',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('18','省份、直辖市','2','sys_area_type','区域类型',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('19','地市','3','sys_area_type','区域类型',30,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('2','删除','1','del_flag','删除标记',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('20','区县','4','sys_area_type','区域类型',40,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('21','接入日志','1','sys_log_type','日志类型',30,'1','2013-06-03 08:00:00','1','2013-06-03 08:00:00',NULL,'0'),('22','异常日志','2','sys_log_type','日志类型',40,'1','2013-06-03 08:00:00','1','2013-06-03 08:00:00',NULL,'0'),('23','系统管理','1','sys_user_type','用户类型',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('24','部门经理','2','sys_user_type','用户类型',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('25','普通用户','3','sys_user_type','用户类型',30,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('26','早晨到校登记','1','mgt_sign_type','对应mgt_sign表中的type',1,'1','2014-07-31 15:50:28','1','2014-07-31 15:50:28',NULL,'0'),('27','放学离校登记','2','mgt_sign_type','对应mgt_sign表中的type',11,'1','2014-07-31 15:51:13','1','2014-07-31 15:51:13',NULL,'0'),('28','早上已到校','1','mgt_sign_value','已到校',10,'1','2014-07-31 15:52:51','1','2014-07-31 15:52:51',NULL,'0'),('29','早上迟到','2','mgt_sign_value','已到校但是迟到',20,'1','2014-07-31 15:53:50','1','2014-07-31 15:53:50',NULL,'0'),('3','显示','1','show_hide','显示/隐藏',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('30','上午未到校','3','mgt_sign_value','上午未到校',30,'1','2014-07-31 15:54:39','1','2014-07-31 15:54:39',NULL,'0'),('31','放学已离校','4','mgt_sign_value','放学已离校',40,'1','2014-07-31 15:56:09','1','2014-07-31 15:56:52',NULL,'0'),('32','放学做值日','5','mgt_sign_value','放学做值日',50,'1','2014-07-31 15:56:42','1','2014-07-31 15:56:42',NULL,'0'),('3f8b90053f164883b6d50e6575d9efd0','已发送','1','mgt_message_status','消息已发送',10,'1','2014-08-12 16:52:39','1','2014-08-12 16:52:39',NULL,'0'),('4','隐藏','0','show_hide','显示/隐藏',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('5','是','1','yes_no','是/否',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('6','否','0','yes_no','是/否',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('7','红色','red','color','颜色值',10,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('8','绿色','green','color','颜色值',20,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('9','蓝色','blue','color','颜色值',30,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('bd96ed7461b741de89d948cfa6c1a417','已接收','2','mgt_message_status','消息已接收',20,'1','2014-08-12 16:53:03','1','2014-08-12 16:53:03',NULL,'0');
...
insert  into `sys_role`(`id`,`name`,`role`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('1','超级管理员','superadmin','1','2013-05-27 08:00:00','1','2014-06-05 16:05:19',NULL,'0'),('2','运营管理员','admin','1','2013-05-27 08:00:00','1','2014-08-12 17:09:23',NULL,'0'),('3','班主任',NULL,'1','2013-05-27 08:00:00','1','2014-07-23 16:57:52',NULL,'0'),('4','普通老师',NULL,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('5','学生家长',NULL,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0'),('6','test',NULL,'1','2013-05-27 08:00:00','1','2013-05-27 08:00:00',NULL,'0');
...
insert  into `sys_user`(`id`,`login_name`,`password`,`no`,`name`,`gender`,`email`,`phone`,`mobile`,`student_no`,`student_name`,`open_level`,`login_ip`,`login_date`,`create_by`,`create_date`,`update_by`,`update_date`,`remarks`,`del_flag`) values ('0bff2462495042f79bbabeb109e20b28','csyay1','3305d2df48eab70744487bf74176ca7d76376201521e396bb6a3bdb5','2012110974','余',NULL,'','','',NULL,NULL,'0','127.0.0.1','2014-07-23 16:12:02','2','2014-05-27 19:17:52','1','2014-06-03 09:31:18','','0'),('1','superadmin','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0001','程序猿',NULL,'chengxuyuan@163.com','8675','8675',NULL,NULL,'0','127.0.0.1','2014-08-12 16:51:25','1','2013-05-27 08:00:00','1','2013-05-27 08:00:00','最高管理员','0'),('10','admin2','c25a42047ed2efc58049a07c2e8a012e83864783ba69653a60d3664d','121212','运营2',NULL,'','867891','8675',NULL,NULL,'0','127.0.0.1','2014-08-12 17:40:54','1','2013-05-27 08:00:00','10','2014-08-04 16:14:15','','0'),('13','jiazhang2','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0013','家长2',NULL,'dede@163.com','8675','8675','22222','王二小','0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 14:10:59','','0'),('14','banzhuren2','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0014','班主任2',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 13:57:41','','0'),('2','admin','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0002','管理员',NULL,'hhaha@163.com','8675','8675',NULL,NULL,'0','127.0.0.1','2014-07-24 16:48:27','1','2013-05-27 08:00:00','1','2014-07-23 17:22:13','','0'),('2025677ee9b847b893695fc1ab423622','jiazhang4','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','438343','家长4',NULL,'','','245242','123634','小刚','1',NULL,NULL,'10','2014-07-24 17:48:17','10','2014-07-30 14:10:25','','0'),('3','banzhuren5','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0003','班头',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 13:57:08','','0'),('4','laoshi1','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0004','数学老师',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 13:58:44','','0'),('5','laoshi','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0005','语文老师',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-28 15:12:20','','0'),('6','jiazhang1','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0006','家长1',NULL,'','8675','8675','242454','李刚','0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 14:11:32','','0'),('636b4f66859c49118dc2b84e10af4023','admin3','482d529d4dec65799bdc94845472f9783e7eea3d4515d351fb41f244','52785287','admin3',NULL,'','57278572','',NULL,NULL,'0',NULL,NULL,'10','2014-07-24 17:09:35','10','2014-07-24 17:26:48','','0'),('7','laoshi3','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0007','laoshi',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-30 14:03:20','','0'),('8','banzhuren8','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0008','班主任8',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-28 15:13:10','','0'),('8ab3ced4f9034b79baa7cc959f51d364','jiazhang3','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','2311231','家长3',NULL,'','','','2012114','小明','1','0:0:0:0:0:0:0:1','2014-06-05 16:24:07','0bff2462495042f79bbabeb109e20b28','2014-05-27 19:22:55','10','2014-07-30 14:10:39','','0'),('9','banzhuren9','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','0009','班主任9',NULL,'','8675','8675',NULL,NULL,'0',NULL,NULL,'1','2013-05-27 08:00:00','10','2014-07-28 15:12:36','','0'),('cabc117c4e9f4f1cb7cb90d97043ad1a','laishi4','02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032','615164','美术老师',NULL,'','','',NULL,NULL,'0',NULL,NULL,'10','2014-07-24 17:37:30','10','2014-07-30 14:00:23','dad','0'),('d939fabeb9e042dbabcb34312ee958cd','adada','56510c2ecf3bcf649e01e984ae76b71bffc5fd3ecd013a181ca00043','dadada','adwd',NULL,'','','',NULL,NULL,'0',NULL,NULL,'0bff2462495042f79bbabeb109e20b28','2014-07-22 11:24:19','0bff2462495042f79bbabeb109e20b28','2014-07-22 11:24:19','','0');
...
insert  into `sys_user_role`(`user_id`,`role_id`) values ('0bff2462495042f79bbabeb109e20b28','1'),('1','1'),('10','2'),('11','3'),('12','4'),('13','5'),('14','3'),('2','2'),('2025677ee9b847b893695fc1ab423622','5'),('3','3'),('4','4'),('5','4'),('6','5'),('636b4f66859c49118dc2b84e10af4023','2'),('7','4'),('8','3'),('8ab3ced4f9034b79baa7cc959f51d364','5'),('9','3'),('cabc117c4e9f4f1cb7cb90d97043ad1a','4'),('d939fabeb9e042dbabcb34312ee958cd','6');
