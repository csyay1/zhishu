 ...
 */
package com.ruijie.modules.sys.security;
...
import com.ruijie.modules.sys.web.LoginController;
import com.ruijie.common.servlet.ValidateCodeServlet;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			List<Menu> list = systemService.getMenuListByUser(user);
			for (Menu menu : list){
			...
			//session
			Session session = SecurityUtils.getSubject().getSession();
			session.setAttribute(UserUtils.CACHE_MENU_LIST, list);
