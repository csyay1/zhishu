...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th class="sort loginName">登录名</th><th class="sort name">姓名</th><th>电话</th><th>手机</th><th>角色</th><shiro:hasPermission name="mgt:parents:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
