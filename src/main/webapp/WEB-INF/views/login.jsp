...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo1.png" alt="ZhiShu Admin" style="height:40px;"></a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
		...
		<%String error = (String) request.getAttribute("message_login");%>
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.ruijie.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":error%></label>
		</div>
        <div id="login-wraper">
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ZhiShu ${fns:getConfig('version')}
    </footer>
  </body>
</html>